...
export const ExpensesView: React.FC<ExpensesViewProps> = ({
  ...
  const [activeMainTab, setActiveMainTab] = useState<'house' | 'work' | 'vehicle' | 'education' | 'reports'>('house');
  ...
  return (
    <div className="space-y-6" id="expenses-gold-module" dir={isAr ? 'rtl' : 'ltr'}>
      {/* Top Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900 p-5 rounded-3xl border border-[#D4AF37]/40 shadow-xl">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#D4AF37]/20 to-amber-600/10 border border-[#D4AF37]/50 text-[#D4AF37] flex items-center justify-center font-bold shadow-md">
        ...
        <div className="flex items-center gap-2">
          <div className="px-4 py-2 rounded-2xl bg-[#D4AF37]/10 border border-[#D4AF37]/30 text-end">
            <span className="text-[10px] text-amber-300 block">{isAr ? 'الإجمالي العام' : 'Grand Total'}</span>
            <span className="text-base sm:text-lg font-black text-[#D4AF37] font-mono-num">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 bg-[#161616] p-1.5 rounded-2xl border border-slate-800">
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center justify-center gap-2 py-3 px-3 rounded-xl font-bold text-xs sm:text-sm transition-all ${
                isActive
                  ? 'bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] text-slate-950 shadow-lg shadow-[#D4AF37]/20 scale-[1.02]'
      ...
      {activeMainTab === 'house' && (
        <div className="space-y-6 animate-fade-in">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            {/* Form */}
            <div className="lg:col-span-5 bg-[#1a1a1a] p-5 rounded-3xl border border-[#D4AF37]/30 shadow-xl space-y-4">
              ...
              <form onSubmit={handleAddHouseExpense} className="space-y-3.5 text-xs">
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full py-3 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] hover:from-[#c29e2f] hover:to-[#967923] text-slate-950 font-extrabold text-xs shadow-lg shadow-[#D4AF37]/20 transition-all active:scale-95"
                  >
            ...
            {/* List & Total */}
            <div className="lg:col-span-7 bg-[#1a1a1a] p-5 rounded-3xl border border-[#D4AF37]/30 shadow-xl flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between pb-3 border-b border-slate-800 mb-4">
                  ...
                  <span className="text-xs font-bold font-mono-num text-[#D4AF37]">
                  ...
                  {houseList.length === 0 ? (
                    ...
                    houseList.map((item) => (
                      <div key={item.id} className="p-3.5 rounded-2xl bg-slate-900 border border-slate-800/80 flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 rounded-xl bg-amber-500/10 border border-amber-500/30 text-[#D4AF37] flex items-center justify-center font-bold">
                            🏠
                          </div>
                          <div>
                            ...
                            <div className="text-[10px] text-slate-400 flex items-center gap-2 mt-0.5">
                              <span>{item.date}</span>
                              <span>•</span>
                              <span className={`px-1.5 py-0.2 rounded font-bold ${item.paymentType === 'supply' ? 'bg-blue-500/10 text-blue-400' : 'bg-amber-500/10 text-amber-300'}`}>
                        ...
                        <div className="flex items-center gap-2">
                          <span className="font-bold text-xs sm:text-sm text-[#D4AF37] font-mono-num">
                            -{item.amount.toLocaleString()} {currency}
                          </span>
                          <button
                            onClick={() => setEditingItem({ kind: 'house', item })}
                            title={isAr ? 'تعديل المصروف' : 'Edit Expense'}
                            className="p-1.5 rounded-lg text-slate-400 hover:text-[#D4AF37] hover:bg-slate-800 transition-all"
                          >
              ...
              <div className="pt-4 border-t border-slate-800 flex justify-end">
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-[#D4AF37] font-bold text-xs border border-[#D4AF37]/30"
                >
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
            <div className="flex items-center gap-2 bg-[#161616] p-1.5 rounded-2xl border border-slate-800 w-full sm:w-auto">
              <button
                ...
                className={`flex-1 sm:flex-initial px-4 py-2 rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 transition-all ${
                  vehicleSubTab === 'fuel' ? 'bg-[#D4AF37] text-slate-950 shadow' : 'text-slate-400 hover:text-white'
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 sm:flex-initial px-4 py-2 rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 transition-all ${
                  vehicleSubTab === 'maintenance' ? 'bg-[#D4AF37] text-slate-950 shadow' : 'text-slate-400 hover:text-white'
                }`}
              >
            ...
            <div className="flex items-center gap-2 justify-end">
              ...
              <button
                ...
                className="flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-amber-500/20 hover:bg-amber-500/30 text-[#D4AF37] font-extrabold text-xs border border-[#D4AF37]/40 shadow-sm active:scale-95 transition-all"
              >
              ...
              <div className="lg:col-span-5 bg-[#1a1a1a] p-5 rounded-3xl border border-[#D4AF37]/30 shadow-xl space-y-4">
                ...
                <form onSubmit={handleAddFuel} className="space-y-3.5 text-xs">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <button
                        type="button"
                        onClick={openOdometerCamera}
                        className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-amber-500/20 text-[#D4AF37] text-[10px] font-bold border border-[#D4AF37]/40 hover:bg-amber-500/30 transition-all active:scale-95"
                      >
                  ...
                  <div className="pt-2">
                    <button
                      type="submit"
                      className="w-full py-3 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] text-slate-950 font-extrabold text-xs shadow-lg shadow-[#D4AF37]/20 transition-all active:scale-95"
                    >
                    ...
                    {fuelList.length === 0 ? (
                      ...
                      fuelList.map((f) => (
                        <div key={f.id} className="p-3.5 rounded-2xl bg-slate-900 border border-slate-800 flex items-center justify-between gap-3">
                          <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-amber-500/10 text-[#D4AF37] flex items-center justify-center font-bold">
                              ⛽
                            </div>
                            <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 items-center">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-2.5 rounded-xl bg-slate-900 border border-[#D4AF37]/50 text-[#D4AF37] font-mono-num font-bold text-sm"
                      />
                    </div>
          ...
          {vehicleSubTab === 'accidents' && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="bg-gradient-to-r from-red-950/40 via-slate-900 to-amber-950/30 p-6 rounded-3xl border border-red-500/30 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-[#D4AF37]/15 hover:bg-[#D4AF37]/25 text-[#D4AF37] font-bold text-xs sm:text-sm border border-[#D4AF37]/40 active:scale-95 transition-all"
                  >
                  ...
                  <button
                    onClick={openOdometerCamera}
                    className="flex items-center gap-2 px-4 py-3 rounded-2xl bg-slate-800 hover:bg-slate-700 text-[#D4AF37] font-bold text-xs sm:text-sm border border-[#D4AF37]/40 active:scale-95 transition-all"
                  >
                    <Activity className="w-4 h-4" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-[#1a1a1a] p-4 rounded-2xl border border-amber-500/20 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-xl font-black text-[#D4AF37] font-mono-num">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {accidentList.length > 0 && (
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#D4AF37]/10 hover:bg-[#D4AF37]/20 text-[#D4AF37] font-bold text-xs border border-[#D4AF37]/30 transition-all"
                    >
                          ...
                          <div className="pt-3 border-t border-slate-800 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-1.5">
                              <button
                                ...
                                className="px-2 py-1.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-[#D4AF37] text-[11px] font-bold border border-[#D4AF37]/30 transition-all flex items-center gap-1"
                              >
                              ...
                              <button
                                ...
                                className="px-2 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-[#D4AF37] text-[11px] font-bold border border-slate-700 transition-all flex items-center gap-1"
                              >
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] text-slate-950 font-bold text-xs shadow-md shadow-[#D4AF37]/20"
            >
              <Plus className="w-4 h-4" />
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-3xl border cursor-pointer transition-all ${
                    isSelected
                      ? 'bg-[#D4AF37]/15 border-[#D4AF37] shadow-xl scale-[1.02]'
                      : 'bg-[#1a1a1a] border-slate-800 hover:border-slate-700'
                  }`}
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="w-10 h-10 rounded-2xl bg-amber-500/20 text-[#D4AF37] flex items-center justify-center font-bold">
                      🎓
                    </div>
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="px-2 py-1 rounded-lg text-[#D4AF37] bg-[#D4AF37]/10 hover:bg-[#D4AF37]/20 border border-[#D4AF37]/30 transition-all flex items-center gap-0.5 text-[10px] font-bold"
                      >
                      ...
                      <button
                        ...
                        className="p-1 rounded-lg text-slate-400 hover:text-[#D4AF37] hover:bg-slate-800 transition-all"
                      >
                  ...
                  <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between gap-2">
                    <div>
                      ...
                      <span className="font-bold text-sm text-[#D4AF37] font-mono-num">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1.5 rounded-xl bg-[#D4AF37]/15 hover:bg-[#D4AF37]/25 text-[#D4AF37] text-[11px] font-bold border border-[#D4AF37]/30 transition-all flex items-center gap-1 active:scale-95"
                    >
          ...
          {activeStudentId && (
            <div className="bg-[#1a1a1a] p-5 rounded-3xl border border-[#D4AF37]/30 shadow-xl space-y-4">
              {(() => {
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-800 mb-4">
                      <div className="flex flex-wrap items-center gap-2.5">
                        <h4 className="font-extrabold text-base text-white flex items-center gap-2">
                          ...
                          <span className="text-xs px-2 py-0.5 rounded bg-[#D4AF37]/20 text-[#D4AF37] font-bold">
                            {currentStd.stage}
                          </span>
                        </h4>
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-xl bg-slate-800 hover:bg-slate-700 text-[#D4AF37] text-xs font-bold border border-[#D4AF37]/30 transition-all flex items-center gap-1.5 shadow-sm active:scale-95"
                        >
                          <Edit className="w-3.5 h-3.5" />
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] hover:from-[#c29d27] hover:to-[#967b25] text-slate-950 text-xs font-black transition-all flex items-center gap-1.5 shadow-md active:scale-95"
                        >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                      ...
                      <div className="lg:col-span-5 bg-slate-900 p-4 rounded-2xl border border-slate-800">
                        <form onSubmit={handleAddStudentExpense} className="space-y-3 text-xs">
                          ...
                          <button
                            type="submit"
                            className="w-full py-2.5 rounded-xl bg-[#D4AF37] hover:bg-amber-400 text-slate-950 font-extrabold text-xs shadow-md"
                          >
                      ...
                      <div className="lg:col-span-7 bg-slate-900 p-4 rounded-2xl border border-slate-800 flex flex-col justify-between">
                            ...
                            stdRecords.map((rec) => (
                              <div key={rec.id} className="p-3 rounded-xl bg-slate-950 border border-slate-800/80 flex items-center justify-between">
                                <div>
                                  ...
                                  <div className="text-[10px] text-slate-400 flex items-center gap-2 mt-0.5">
                                    <span className="px-1.5 py-0.2 rounded bg-amber-500/10 text-amber-300 font-bold uppercase">{rec.subCategory}</span>
                                    <span>{rec.date}</span>
                                  </div>
                                </div>
                                <div className="flex items-center gap-2">
                                  <span className="font-bold text-xs text-[#D4AF37] font-mono-num">
                                    -{rec.amount.toLocaleString()} {currency}
                                  </span>
                                  <button
                                    onClick={() => setEditingItem({ kind: 'studentExpense', item: rec })}
                                    title={isAr ? 'تعديل المصروف' : 'Edit Expense'}
                                    className="p-1 rounded-lg text-slate-400 hover:text-[#D4AF37] hover:bg-slate-900 transition-all"
                                  >
                                    <Edit className="w-3.5 h-3.5" />
                                  </button>
                                  <button
                        ...
                        <div className="pt-3 border-t border-slate-800 flex justify-between items-center text-xs">
                          ...
                          <span className="font-extrabold text-[#D4AF37] font-mono-num">
              ...
              <div className="bg-[#1c1c1c] border border-[#D4AF37]/40 w-full max-w-md rounded-3xl p-6 shadow-2xl space-y-4 text-white">
                ...
                <form onSubmit={handleAddStudent} className="space-y-3.5 text-xs">
                  ...
                  <div className="pt-3 border-t border-slate-800 flex justify-end gap-2">
                    ...
                    <button
                      type="submit"
                      className="px-5 py-2 rounded-xl bg-[#D4AF37] hover:bg-amber-400 text-slate-950 font-bold"
                    >
      ...
      {activeMainTab === 'reports' && (
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="bg-gradient-to-r from-slate-900 via-[#161616] to-slate-900 p-4 rounded-3xl border border-[#D4AF37]/40 shadow-xl flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex-1 md:flex-initial flex items-center justify-center gap-2 px-5 py-2.5 rounded-2xl bg-gradient-to-r from-[#D4AF37] to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs shadow-lg shadow-amber-900/30 active:scale-95 transition-all"
              >
            ...
            {[
              ...
              <button
                ...
                className={`flex-1 py-2.5 px-3 rounded-xl font-bold text-xs transition-all text-center ${
                  reportSubTab === sub.id
                    ? 'bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] text-slate-950 shadow-md'
                    : 'text-slate-400 hover:text-white hover:bg-slate-800/60'
                }`}
              >
                {sub.label}
          ...
          {reportSubTab === 'master' && (
            <div className="space-y-6 animate-fade-in">
              {/* Summary Cards */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-[#1a1a1a] p-5 rounded-3xl border border-[#D4AF37]/30 shadow-xl">
                  ...
                  <div className="text-xl sm:text-2xl font-black text-white font-mono-num">
                    {totalHouseSpent.toLocaleString()} <span className="text-xs text-[#D4AF37]">{currency}</span>
                  </div>
                ...
                <div className="bg-[#1a1a1a] p-5 rounded-3xl border border-[#D4AF37]/30 shadow-xl">
                  ...
                  <div className="text-xl sm:text-2xl font-black text-white font-mono-num">
                    {totalWorkSpent.toLocaleString()} <span className="text-xs text-[#D4AF37]">{currency}</span>
                  </div>
                ...
                <div className="bg-[#1a1a1a] p-5 rounded-3xl border border-[#D4AF37]/30 shadow-xl">
                  ...
                  <div className="text-xl sm:text-2xl font-black text-white font-mono-num">
                    {totalVehicleSpent.toLocaleString()} <span className="text-xs text-[#D4AF37]">{currency}</span>
                  </div>
                ...
                <div className="bg-[#1a1a1a] p-5 rounded-3xl border border-[#D4AF37]/30 shadow-xl">
                  ...
                  <div className="text-xl sm:text-2xl font-black text-white font-mono-num">
                    {totalEduSpent.toLocaleString()} <span className="text-xs text-[#D4AF37]">{currency}</span>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                {/* Bar Chart */}
                <div className="lg:col-span-7 bg-[#1a1a1a] p-6 rounded-3xl border border-[#D4AF37]/30 shadow-xl space-y-4">
                  <h3 className="font-extrabold text-sm text-white flex items-center gap-2">
                ...
                {/* Pie Chart */}
                <div className="lg:col-span-5 bg-[#1a1a1a] p-6 rounded-3xl border border-[#D4AF37]/30 shadow-xl space-y-4 flex flex-col justify-between">
                  <h3 className="font-extrabold text-sm text-white flex items-center gap-2">
                  ...
                  <div className="text-center text-xs text-slate-400 pt-2 border-t border-slate-800">
                    {isAr ? 'الإجمالي العام المجمع:' : 'Grand Total Combined:'} <span className="font-bold text-[#D4AF37] font-mono-num">{grandTotal.toLocaleString()} {currency}</span>
                  </div>
                </div>
              </div>

              {/* Period Comparison & Export */}
              <div className="bg-[#1a1a1a] p-6 rounded-3xl border border-[#D4AF37]/30 shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] text-slate-950 font-extrabold text-xs shadow-md"
                  >
                    <Download className="w-4 h-4" />
          ...
          {reportSubTab === 'sections' && (
            <div className="space-y-6 animate-fade-in bg-[#1a1a1a] p-6 rounded-3xl border border-[#D4AF37]/30 shadow-xl">
                ...
                {reportSectionChoice === 'house' && (
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <h4 className="font-bold text-xs text-amber-300">{isAr ? 'سجل مصروفات المنزل الكامل' : 'House Expenses Log'}</h4>
                      <span className="font-mono-num text-xs font-bold text-[#D4AF37]">{totalHouseSpent.toLocaleString()} {currency}</span>
                    </div>
                      ...
                      {houseList.length === 0 ? (
                        ...
                        houseList.map((h) => (
                          <div key={h.id} className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex justify-between items-center text-xs">
                            ...
                            <span className="font-bold text-[#D4AF37] font-mono-num">-{h.amount} {currency}</span>
                          </div>
                        ))
                      )}
                    </div>
                ...
                {reportSectionChoice === 'work' && (
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <span className="font-mono-num text-xs font-bold text-[#D4AF37]">{totalWorkSpent.toLocaleString()} {currency}</span>
                    </div>
                    <div className="space-y-2 max-h-[400px] overflow-y-auto">
                      {workList.length === 0 ? (
                        <div className="text-center py-10 text-slate-500 text-xs">{isAr ? 'لا توجد بيانات' : 'No records'}</div>
                        ...
                        workList.map((w) => (
                          <div key={w.id} className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex justify-between items-center text-xs">
                            ...
                            <span className="font-bold text-[#D4AF37] font-mono-num">-{w.amount} {currency}</span>
                          </div>
                        ))
                      )}
                    </div>
                ...
                {reportSectionChoice === 'vehicle' && (
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-mono-num text-xs font-bold text-[#D4AF37]">{totalVehicleSpent.toLocaleString()} {currency}</span>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800">
                        <h5 className="font-bold text-xs text-amber-300 mb-2">{isAr ? 'سجل التموين' : 'Fuel Log'} ({totalFuelSpent} {currency})</h5>
                        <div className="space-y-2 max-h-[220px] overflow-y-auto">
                          {fuelList.map((f) => (
                            <div key={f.id} className="p-2 rounded-lg bg-slate-950 text-xs flex justify-between">
                              <span>{f.fuelType} ({f.dateTime})</span>
                              <span className="text-[#D4AF37] font-bold">-{f.price} {currency}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                        ...
                        <div className="space-y-2 max-h-[220px] overflow-y-auto">
                          {maintList.map((m) => (
                            <div key={m.id} className="p-2 rounded-lg bg-slate-950 text-xs flex justify-between">
                              ...
                              <span className="text-[#D4AF37] font-bold">-{m.total} {currency}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                ...
                {reportSectionChoice === 'education' && (
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <span className="font-mono-num text-xs font-bold text-[#D4AF37]">{totalEduSpent.toLocaleString()} {currency}</span>
                    </div>
                    <div className="space-y-2 max-h-[400px] overflow-y-auto">
                        ...
                        studentExpensesList.map((se) => {
                          ...
                          return (
                            <div key={se.id} className="p-3 rounded-xl bg-slate-900 border border-slate-800 flex justify-between items-center text-xs">
                              <div>
                                <div className="font-bold text-white">{se.title} <span className="text-amber-400 font-normal">({std?.name || 'طالب'})</span></div>
                                <div className="text-[10px] text-slate-400">{se.date} • {se.subCategory}</div>
                              </div>
                              <span className="font-bold text-[#D4AF37] font-mono-num">-{se.amount} {currency}</span>
                            </div>
                          );
                        })
                      )}
          ...
          {reportSubTab === 'students' && (
            <div className="space-y-6 animate-fade-in">
              ...
              {studentReportToast && (
                <div className="p-4 rounded-2xl bg-[#D4AF37]/20 border border-[#D4AF37]/50 text-white flex items-center justify-between shadow-lg">
                  <div className="flex items-center gap-2 font-bold text-xs sm:text-sm text-[#D4AF37]">
              ...
              <div className="bg-[#1a1a1a] p-5 rounded-3xl border border-[#D4AF37]/30 shadow-xl space-y-3">
                    ...
                    return (
                      <button
                        ...
                        className={`p-3.5 rounded-2xl border text-start transition-all flex flex-col justify-between gap-2.5 relative overflow-hidden group ${
                          isSelected
                            ? 'bg-gradient-to-br from-[#D4AF37]/20 via-slate-900 to-slate-900 border-[#D4AF37] shadow-lg shadow-[#D4AF37]/10 ring-1 ring-[#D4AF37]'
                      ...
                      >
                            ...
                            <div
                              className={`w-9 h-9 rounded-xl flex items-center justify-center font-bold text-sm ${
                                isSelected
                                  ...
                                  : 'bg-slate-800 text-slate-300 group-hover:bg-[#D4AF37]/20 group-hover:text-[#D4AF37]'
                              }`}
                            >
                              🎓
                            </div>
                        ...
                        <div className="pt-2 border-t border-slate-800/80 flex items-center justify-between text-xs">
                          ...
                          <span className="font-bold text-[#D4AF37] font-mono-num">
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-6">
                    ...
                    <div className="bg-[#1a1a1a] p-6 rounded-3xl border border-[#D4AF37]/40 shadow-2xl space-y-6">
                      {/* Top Header & Actions */}
                      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-5 border-b border-slate-800">
                        {/* Student Identity Information */}
                        <div className="flex items-start sm:items-center gap-4">
                          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#D4AF37] to-[#aa8c2c] text-slate-950 flex items-center justify-center text-2xl font-black shadow-lg shadow-[#D4AF37]/20 flex-shrink-0">
                            🎓
                          </div>
                          <div>
                            <div className="flex flex-wrap items-center gap-2">
                              <h3 className="text-lg sm:text-xl font-black text-white">
                                ...
                                <span className="text-[#D4AF37]">{selStd.name}</span>
                              </h3>
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <button
                            ...
                            className="px-3.5 py-2.5 rounded-2xl bg-slate-900 hover:bg-slate-800 text-[#D4AF37] font-bold text-xs border border-[#D4AF37]/40 transition-all flex items-center gap-2 active:scale-95"
                          >
                            <Edit className="w-4 h-4" />
                          ...
                          <button
                            ...
                            className="px-4 py-2.5 rounded-2xl bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] hover:from-[#c29d27] hover:to-[#967b25] text-slate-950 font-black text-xs transition-all flex items-center gap-2 shadow-lg shadow-[#D4AF37]/20 active:scale-95"
                          >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-2xl bg-slate-900/90 border border-slate-800">
                        ...
                        <div className="flex items-center gap-3">
                          <div className="text-end">
                            ...
                            <span className="text-xl sm:text-2xl font-black text-[#D4AF37] font-mono-num">
                        ...
                        {filteredStdTotal > 0 && (
                          <div className="mt-3 p-3 rounded-2xl bg-slate-900 border border-slate-800 space-y-2">
                            <div className="flex justify-between text-[11px] text-slate-400 font-bold">
                              ...
                              <span className="text-[#D4AF37]">{filteredStdTotal.toLocaleString()} {currency}</span>
                            </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              onClick={() => handleOpenStudentModal(selStd, 'addExpense')}
                              className="px-2.5 py-1 rounded-xl bg-[#D4AF37]/15 hover:bg-[#D4AF37]/25 text-[#D4AF37] text-[11px] font-bold border border-[#D4AF37]/30 transition-all flex items-center gap-1 active:scale-95"
                            >
                              <Plus className="w-3.5 h-3.5" />
                              ...
                              <tbody className="divide-y divide-slate-800/80">
                                {filteredStdRecords.map((rec, idx) => {
                                  const subColors: Record<string, string> = {
                                    lessons: 'bg-amber-500/20 text-amber-300 border-amber-500/30',
                                  ...
                                  return (
                                    <tr key={rec.id} className="hover:bg-slate-800/50 transition-colors">
                                      ...
                                      <td className="p-3 font-mono-num font-black text-[#D4AF37] whitespace-nowrap">
                                        -{rec.amount.toLocaleString()} {currency}
                                      </td>
                              ...
                              return (
                                <tr
                                  ...
                                  className={`transition-colors ${
                                    isCurrent ? 'bg-[#D4AF37]/10' : 'hover:bg-slate-800/40'
                                  }`}
                                >
                                  <td className="p-3 font-black text-white flex items-center gap-2">
                                    ...
                                    <span>{s.name}</span>
                                    {isCurrent && (
                                      <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#D4AF37] text-slate-950 font-bold">
                                  ...
                                  <td className="p-3 font-mono-num font-black text-[#D4AF37]">
                                  ...
                                  <td className="p-3 text-end">
                                    <div className="flex items-center justify-end gap-2">
                                      ...
                                      <button
                                        ...
                                        className="p-1.5 rounded-xl bg-slate-800 hover:bg-[#D4AF37]/20 text-[#D4AF37] border border-[#D4AF37]/30 transition-all"
                                      >
                                        <Printer className="w-3.5 h-3.5" />
                                      </button>
                                    </div>
