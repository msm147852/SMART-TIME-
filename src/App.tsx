...
export default function App() {
  ...
  const handleGuest = () => { setGuestMode(true); setAuthenticated(true); };

  const handleNavigateSafe = (nextView: AppView) => {
    // Chat does not require phone verification. The phone number is optional account data only.
  ...
  if (!authenticated) return <AuthView onAuthenticated={handleAuthenticated} onGuest={handleGuest} />;
